...
public class TestFixtures implements TargetType {
    public static final String TARGET_TYPE_ID = "test-fixtures";
    ...
    public TargetType resourceTarget() {
        return Targets.byId(TestFixturesResources.TARGET_TYPE_ID);
    }
}
